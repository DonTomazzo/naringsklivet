...
import { CheckCircle, XCircle, Award, Clock, Zap, Target, TrendingUp } from 'lucide-react';
...
interface QuizSectionProps {
  ...
  minPassingScore?: number; // percentage, default 70
}
    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-[#FF5421] to-[#FF7851] text-white font-semibold py-4 rounded-xl hover:shadow-xl transition-all flex items-center justify-center gap-2"
        >
