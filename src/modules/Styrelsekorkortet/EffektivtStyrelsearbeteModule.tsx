...
import { 
  ...
  Sparkles, Lightbulb, Target, Zap, Rocket, Calendar, Cpu
} from 'lucide-react';
...
const EffektivtStyrelsearbeteModule = () => {
  ...
  const courseContent = [
    ...
    {
      id: 'tidsplanering',
      title: 'Tidsplanering och prioritering',
      type: 'text',
      phase: 'grunderna',
      icon: Calendar,
      duration: '10 min läsning',
    ...
    {
      id: 'delegering',
      title: 'Delegering och uppföljning',
      type: 'text',
      phase: 'grunderna',
      icon: Target,
      duration: '10 min läsning',
    ...
    {
      id: 'video-effektivitet',
      title: 'Video: Effektivt styrelsearbete',
      type: 'video',
      phase: 'grunderna',
      icon: Video,
    ...
    {
      id: 'digitala-verktyg',
      title: 'Digitala verktyg för styrelsen',
      type: 'text',
      phase: 'avancerat',
      icon: Cpu,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <section data-section="intro" className="min-h-screen flex items-center relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-6 relative z-10">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="inline-block bg-[#A855F7] text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
                ✨ MODUL 11
              </div>
              ...
              <p className="text-2xl text-gray-200 mb-8 leading-relaxed">
                Optimera styrelsens arbete för bättre resultat och effektivitet.
                Praktiska tips och metoder för att göra styrelsearbetet mer produktivt.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
                ...
                >
                  <Rocket className="w-12 h-12 text-[#A855F7] mb-3" />
                  <h3 className="text-xl font-bold text-white mb-2">6 Lektioner</h3>
                  <p className="text-gray-300">Effektivitet och produktivitet</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05, y: -5 }}
                  className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20"
                >
                  <Video className="w-12 h-12 text-[#A855F7] mb-3" />
                  <h3 className="text-xl font-bold text-white mb-2">Video-lektioner</h3>
                  <p className="text-gray-300">Se best practices</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05, y: -5 }}
                  className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20"
                >
                  <Award className="w-12 h-12 text-[#A855F7] mb-3" />
                  <h3 className="text-xl font-bold text-white mb-2">840 Poäng</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => scrollToSection('effektiva-moten')}
                  className="bg-[#A855F7] text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-[#9333EA] transition-all flex items-center justify-center space-x-2"
                >
        ...
        {/* Effektiva möten */}
        <section data-section="effektiva-moten" className="min-h-screen flex items-center py-20 bg-white">
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-slate-600 leading-relaxed mb-6">
                  Styrelsemöten är styrelsens viktigaste arbetsform. Effektiva möten sparar tid 
                  och skapar engagemang. Lär dig hur du genomför produktiva styrelsemöten.
                </p>

                <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 my-8">
                  <h3 className="text-2xl font-semibold text-slate-800 mb-4">Nycklar till effektiva möten</h3>
                  <ul className="space-y-3 text-slate-600">
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#A855F7] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Tydlig agenda:</strong> Skicka ut i god tid före mötet</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#A855F7] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Tidsgränser:</strong> Sätt och håll tidsramar för varje ärende</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#A855F7] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Förberedelser:</strong> Alla ska läsa materialet innan mötet</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#A855F7] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Möteskultur:</strong> Skapa en kultur av respekt och aktivt lyssnande</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-[#171f32] border border-slate-700 rounded-xl p-6 my-8">
                  <h3 className="text-xl font-semibold text-white mb-4">Mötesstruktur</h3>
                  <div className="bg-black/50 p-4 rounded-lg">
                    <p className="text-gray-300 mb-3">• Börja i tid och avsluta i tid</p>
                    <p className="text-gray-300 mb-3">• Följ agendan och undvik sidospår</p>
                    <p className="text-gray-300 mb-3">• Dokumentera beslut tydligt</p>
                    <p className="text-gray-300 mb-3">• Tilldela ansvar och deadlines</p>
                    <p className="text-gray-300">• Sammanfatta nästa steg innan mötet avslutas</p>
                  </div>
                </div>
              ...
              {!completedLessons.has('effektiva-moten') ? (
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => handleCompleteLesson('effektiva-moten')}
          ...
          <div className="max-w-5xl mx-auto px-6 relative z-10 w-full">
            ...
            >
              <h2 className="text-5xl font-bold text-white mb-6 text-center">
                Slutprov - Effektivt styrelsearbete
              </h2>
              ...
              {activeQuizId !== 'slutprov' ? (
                <motion.button
                  ...
                  className="bg-gradient-to-r from-[#A855F7] to-[#9333EA] text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-lg transition-all flex items-center space-x-2 mx-auto"
                >
...
export default EffektivtStyrelsearbeteModule;