...
import { 
  ...
  Sparkles, Lightbulb, Target, Zap, FileText, TrendingUp, PieChart
} from 'lucide-react';
...
const ArsredovisningModule = () => {
  ...
  const courseContent = [
    ...
    {
      id: 'vad-ar-arsredovisning',
      title: 'Vad är en årsredovisning?',
      type: 'text',
      phase: 'grunderna',
      icon: FileText,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <section data-section="intro" className="min-h-screen flex items-center relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-6 relative z-10">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="inline-block bg-[#14B8A6] text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
                ✨ MODUL 9
              </div>
              ...
              <p className="text-2xl text-gray-200 mb-8 leading-relaxed">
                Förstå och tolka bostadsrättsföreningens årsredovisning.
                Lär dig läsa resultaträkning, balansräkning och förvaltningsberättelse.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
                ...
                >
                  <PieChart className="w-12 h-12 text-[#14B8A6] mb-3" />
                  <h3 className="text-xl font-bold text-white mb-2">10 Lektioner</h3>
                  <p className="text-gray-300">Från grunder till analys</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05, y: -5 }}
                  className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20"
                >
                  <Video className="w-12 h-12 text-[#14B8A6] mb-3" />
                ...
                <motion.div
                  ...
                  className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20"
                >
                  <Award className="w-12 h-12 text-[#14B8A6] mb-3" />
                  <h3 className="text-xl font-bold text-white mb-2">1470 Poäng</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => scrollToSection('vad-ar-arsredovisning')}
                  className="bg-[#14B8A6] text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-[#0D9488] transition-all flex items-center justify-center space-x-2"
                >
        ...
        <section data-section="vad-ar-arsredovisning" className="min-h-screen flex items-center py-20 bg-white">
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-slate-600 leading-relaxed mb-6">
                  Årsredovisningen är en sammanställning av föreningens ekonomiska ställning och 
                  resultat under det gångna räkenskapsåret. Den är ett viktigt underlag för 
                  styrelsens och medlemmarnas bedömning av föreningens ekonomi.
                </p>

                <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 my-8">
                  <h3 className="text-2xl font-semibold text-slate-800 mb-4">Årsredovisningens delar</h3>
                  <ul className="space-y-3 text-slate-600">
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#14B8A6] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Förvaltningsberättelse:</strong> Översikt av verksamheten</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#14B8A6] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Resultaträkning:</strong> Intäkter och kostnader</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#14B8A6] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Balansräkning:</strong> Tillgångar och skulder</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#14B8A6] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Noter:</strong> Förklarande information</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-[#171f32] border border-slate-700 rounded-xl p-6 my-8">
                  <h3 className="text-xl font-semibold text-white mb-4">Varför är årsredovisningen viktig?</h3>
                  <div className="bg-black/50 p-4 rounded-lg">
                    <p className="text-gray-300 mb-3">• Ger insyn i föreningens ekonomi</p>
                    <p className="text-gray-300 mb-3">• Underlag för beslut på årsstämman</p>
                    <p className="text-gray-300 mb-3">• Visar utveckling över tid</p>
                    <p className="text-gray-300">• Används av banker vid lånebedömning</p>
                  </div>
                </div>
              ...
              {!completedLessons.has('vad-ar-arsredovisning') ? (
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => handleCompleteLesson('vad-ar-arsredovisning')}
            ...
            >
              ...
              {activeQuizId !== 'quiz-grunderna' ? (
                <motion.button
                  ...
                  className="bg-gradient-to-r from-[#14B8A6] to-[#0D9488] text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-lg transition-all flex items-center space-x-2 mx-auto"
                >
