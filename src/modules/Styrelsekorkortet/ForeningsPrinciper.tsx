...
import { 
  ...
  Sparkles, Lightbulb, Target, Zap, Users, Scale, Eye
} from 'lucide-react';
...
const ForeningsPrinciperModule = () => {
  ...
  const courseContent = [
    ...
    {
      id: 'demokratiprincipen',
      title: 'Demokratiprincipen',
      type: 'text',
      phase: 'grunderna',
      icon: Users,
    ...
    {
      id: 'likstallighet',
      title: 'Likställdhet och rättvisa',
      type: 'text',
      phase: 'grunderna',
      icon: Scale,
    ...
    {
      id: 'transparens',
      title: 'Transparens och öppenhet',
      type: 'text',
      phase: 'grunderna',
      icon: Eye,
      duration: '10 min läsning',
    ...
    {
      id: 'video-principer',
      title: 'Video: Principer i praktiken',
      type: 'video',
      phase: 'grunderna',
      icon: Video,
    ...
    {
      id: 'medlemmar-rattigheter',
      title: 'Medlemmars rättigheter',
      type: 'text',
      phase: 'avancerat',
      icon: Target,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
          ...
          <div className="max-w-5xl mx-auto px-6 relative z-10">
            ...
            >
              ...
              <h1 className="text-6xl font-bold text-white mb-6">
                Föreningens olika principer
              </h1>
              
              <p className="text-2xl text-gray-200 mb-8 leading-relaxed">
                Lär dig de grundläggande principerna för hur en förening ska drivas.
                Från demokrati till transparens och medlemmars rättigheter.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
                ...
                >
                  <Scale className="w-12 h-12 text-[#8B5CF6] mb-3" />
                  <h3 className="text-xl font-bold text-white mb-2">7 Lektioner</h3>
                  <p className="text-gray-300">Grundläggande principer</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05, y: -5 }}
                  className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20"
                >
                  ...
                  <p className="text-gray-300">Se praktiska exempel</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05, y: -5 }}
                  className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20"
                >
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">950 Poäng</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => scrollToSection('demokratiprincipen')}
        ...
        {/* Demokratiprincipen */}
        <section data-section="demokratiprincipen" className="min-h-screen flex items-center py-20 bg-white">
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-slate-600 leading-relaxed mb-6">
                  Demokratiprincipen är grunden för hur en bostadsrättsförening ska drivas. 
                  Alla medlemmar har rätt att delta i beslut och påverka föreningens verksamhet.
                </p>

                <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 my-8">
                  <h3 className="text-2xl font-semibold text-slate-800 mb-4">Demokratiska rättigheter</h3>
                  <ul className="space-y-3 text-slate-600">
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#8B5CF6] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Rösträtt:</strong> Alla medlemmar har lika rösträtt på stämman</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#8B5CF6] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Yttrande­frihet:</strong> Rätt att uttrycka åsikter och förslag</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#8B5CF6] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Information:</strong> Rätt till insyn i föreningens verksamhet</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <Zap className="w-5 h-5 text-[#8B5CF6] mt-1 flex-shrink-0" />
                      <span><strong className="text-slate-800">Valbarhet:</strong> Möjlighet att kandidera till styrelsen</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-[#171f32] border border-slate-700 rounded-xl p-6 my-8">
                  <h3 className="text-xl font-semibold text-white mb-4">Exempel på demokrati i praktiken</h3>
                  <div className="bg-black/50 p-4 rounded-lg">
                    <p className="text-gray-300 mb-3">• Årsstämman där alla medlemmar har rösträtt</p>
                    <p className="text-gray-300 mb-3">• Öppna styrelsemöten med möjlighet för medlemmar att närvara</p>
                    <p className="text-gray-300 mb-3">• Val av styrelse genom demokratiska processer</p>
                    <p className="text-gray-300">• Medlemsförslag som behandlas på stämman</p>
                  </div>
                </div>
              ...
              {!completedLessons.has('demokratiprincipen') ? (
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => handleCompleteLesson('demokratiprincipen')}
...
export default ForeningsPrinciperModule;