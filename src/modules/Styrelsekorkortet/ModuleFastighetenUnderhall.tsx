// src/modules/Styrelsekorkortet/ModuleFastighetenUnderhall.tsx
// Kapitel: Underhåll & planering — del av Fastigheten-utbildningen
...
// HUVUD-KOMPONENT
// ════════════════════════════════════════════════════════
const ModuleFastighetenUnderhall: React.FC = () => {
    ...
    <div className="h-screen flex flex-col overflow-hidden bg-white">
      <div className="flex-shrink-0" data-course-header style={{ background: '#0f1623' }}>
        <div className="flex items-center justify-between px-4 py-2" style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <span className="text-xs font-bold" style={{ color: O }}>🔧 Underhåll & planering</span>
          <div className="flex gap-2">
          <motion.button onClick={() => navigate('/modules/fastigheten-sakerhet')}
            whileHover={{ x: -2 }} whileTap={{ scale: 0.97 }}
      ...
      <SlideSidebar slides={slides} currentIndex={currentIndex}
        ...
        courseTitle="Underhåll & planering" userName={userData.name}
      ...
      <FloatingFAQ faqs={[{ question: 'Hur ofta OVK?', answer: 'FT/FTX: vart 3:e år. Självdrag: vart 6:e år.' }, { question: 'Vad är egenkontroll?', answer: 'Löpande kontrollsystem — ska dokumenteras.' }, { question: 'Missad OVK?', answer: 'Kommunen kan förelägga och ta ut avgift.' }]}
        title="Frågor om underhåll & planering"
        subtitle="OVK, egenkontroll och underhållsplanering."
        buttonColor={O} />
    </div>
  );
};

export default ModuleFastighetenUnderhall;