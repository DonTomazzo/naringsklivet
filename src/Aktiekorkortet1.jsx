...
import DynamicQuizPage from './components/DynamicQuizPage.jsx';
import VideoPopupHero from './components/VideoPopupHero.jsx'; 
import TestimonialCarousel from './components/TestimonialCarousel.jsx';
import TextModal from './components/TextModal.js';
import BlogPage from './pages/BlogPage.js';
import BlogPostPage from './pages/BlogPostPage.js';
import NewsCards from './components/blog/NewsCards.js';
import ContactForm from './components/ContactForm.jsx';
import AnimatedHeroImage from './components/AnimatedHeroImage.jsx';
...
import ModuleCard from './components/ModuleCard2.jsx';

import { aktieModulesData } from './data/modules3';
import { ToastContainer } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
import LandingPage from './pages/LandingPage.js';
import CourseFormPage from './pages/CourseFormPage.js';
import SimpleCourseForm from './components/CourseContactForm.js';
import PublicSurvey from './components/surveys/PublicSurvey.jsx';
import { SurveyProvider } from './contexts/MockSurveyContext.jsx';
import { DocumentProvider } from './contexts/MockDocumentContext.jsx';
import { AdaptiveHomeworkApp } from './features/adaptive-quiz/App.js';
import DemoPage4 from "./pages/DemoPages/DemoPage4.js";
...
import './i18n.js'; // Se till att i18n initialiseras
import AdminDashboard from './components/admin/AdminDashboard.jsx';

// ⭐ Auth komponenter
import { TeamProvider, useTeam } from './contexts/MockTeamContext.jsx';
import TeamCodeRegister from './components/auth/TeamCodeRegister.jsx';
import LoginForm from './components/auth/LoginForm.jsx';
import TeamMemberDashboard from './components/auth/TeamMemberDashboard.jsx';
import TeamLeaderDashboard from './components/auth/TeamLeaderDashboard.jsx';
...
const heroSlides = [
    {
      title: "Ökad avkastning genom minskad riskexponering",
...
const PremiumCoursePage = () => {
  ...
  const VIDEO_URL = "https://www.youtube.com/embed/qz0aGYrrlhU";
            ...
            >
              ...
              <div>
                <div className="text-xl font-bold text-slate-800">
                  <span className="text-[#FF5421]"> Aktie</span>körkortet
                </div>
              </div>
            </motion.div>
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
      ...
      >
        ...
        <h3 className="text-xl font-bold text-slate-900">Program för förtroendevalda i BRF:er</h3>
      </motion.div>
      ...
      >
        ...
        <h3 className="text-xl font-bold text-slate-900">All inclusive - ekonomi, juridik & teknik</h3>
      </motion.div>
      ...
      >
        ...
        <h3 className="text-xl font-bold text-slate-900">15 onlinemoduler - välj själv tid och takt</h3>
      </motion.div>
      ...
      >
        ...
        <h3 className="text-xl font-bold text-slate-900">Certifierad småsparare</h3>
      </motion.div>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
      ...
      <div>
        ...
        <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6 leading-tight">
          Bli tryggare med din aktieportfölj.
        </h2>
        
        <div className="space-y-4 text-lg text-slate-600 mb-12">
          <p>
            Att vara förtroendevald i en bostadsrättsförening innebär ett stort ansvar. Du fattar beslut som påverkar både ekonomi, trivsel och värde för alla medlemmar. 
            Du ska också kunna hantera konfliktfyllda situationer, 
          </p>
          <p>
...
<div>
  <div className="bg-[#FF5421] text-white px-6 py-4 rounded-t-xl">
    <h3 className="text-2xl font-bold">Kommande webbinarier</h3>
  </div>
...
<section id="courses" className="py-20 bg-gray-50">
  <div className="max-w-7xl mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {aktieModulesData.map((module, index) => (  
        <motion.div
          key={module.id}
  ...
  <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
    ...
    <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm text-white/80 mt-8">
      <div className="flex items-center gap-2">
        <CheckCircle className="text-[#FF5421]" size={16} />
